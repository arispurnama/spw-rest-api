...
const ApproveModal = ({isOpen, Id, page, onClosed}:Props) => {
  ...
  const Approve = async () => {
    try {
      axios
      .patch(`http://localhost:3030/approve-laporan/${Id}`, {}, {
        headers: {
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
      <div className="bg-white p-6 rounded shadow-lg">
        <h2 className="text-xl font-bold mb-4">Confirm Approve Data!!!</h2>
        <p>Are you sure you want to approve this data?</p>
