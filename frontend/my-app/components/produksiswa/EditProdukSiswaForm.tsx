...
const EditProdukSiswaForm = ({
  ...
  if (!isOpen) {
    ...
    const [namaProduk, setNamaProduk] = useState(DataEdit?.namaProduk);
    const [keterangan, setKeterangan] = useState(DataEdit?.keterangan);
    const [tanggal, setTanggal] = useState(DataEdit?.tanggalproduk);
          ...
          <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
            <div className="flex items-center justify-center bg-gray-100">
              <div className="bg-white rounded-lg shadow-lg p-8 max-w-screen-md w-full">
                <h2 className="text-2xl font-bold mb-4">Edit Produk Siswa</h2>
...
export default EditProdukSiswaForm;
